        ...
        <div className="relative rounded-[28px] border-4 border-black shadow-[10px_10px_0_0_rgba(0,0,0,0.6)] bg-gradient-to-br from-teal-300 via-rose-200 to-amber-200 p-4 sm:p-6 mb-4 overflow-hidden">
          ...
          <div className="mb-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <button onClick={()=>setShowMilestones(true)} className="ml-auto text-xs px-2 py-1 rounded-full bg-white flex items-center gap-1 shadow-none active:shadow-none active:translate-y-0"><Trophy size={14}/> Meilensteine</button>
            </div>
